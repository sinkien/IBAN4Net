...
namespace SinKien.IBAN4Net
{
	public class CountryCode
	{
		...
		/// <summary>
		/// Returns all Eurozone SEPA Members 
		/// (Countries using EUR as main currency)
		/// </summary>
		/// <returns>IEnumerable of Eurozone countries participating in SEPA</returns>
		public static IEnumerable<CountryCodeEntry> GetEurozoneSEPACountryCodes() => _alpha3Map.Values.Where(x => x.IsSEPAMember && x.IsUsingEuros);

		public static IEnumerable<CountryCodeEntry> GetAllSEPACountryCodes() => _alpha3Map.Values.Where(x => x.IsSEPAMember);
		...
		private static void loadMap()
		{
			...
			_alpha3Map.Add("AX", new CountryCodeEntry() { Alpha2 = "AX", Alpha3 = "ALA", CountryName = "Åland Islands", IsSEPAMember = true, IsUsingEuros = true });
			...
			_alpha3Map.Add("AD", new CountryCodeEntry() { Alpha2 = "AD", Alpha3 = "AND", CountryName = "Andorra", IsSEPAMember = true, IsUsingEuros = true });
			...
			_alpha3Map.Add("AT", new CountryCodeEntry() { Alpha2 = "AT", Alpha3 = "AUT", CountryName = "Austria", IsSEPAMember = true, IsUsingEuros = true }); ;
			...
			_alpha3Map.Add("BE", new CountryCodeEntry() { Alpha2 = "BE", Alpha3 = "BEL", CountryName = "Belgium", IsSEPAMember = true, IsUsingEuros = true });
			...
			_alpha3Map.Add("BG", new CountryCodeEntry() { Alpha2 = "BG", Alpha3 = "BGR", CountryName = "Bulgaria", IsSEPAMember = true });
			...
			_alpha3Map.Add("CZ", new CountryCodeEntry() { Alpha2 = "CZ", Alpha3 = "CZE", CountryName = "Czech Republic", IsSEPAMember = true });
			_alpha3Map.Add("CN", new CountryCodeEntry() { Alpha2 = "CN", Alpha3 = "CHN", CountryName = "China" });
			_alpha3Map.Add("DK", new CountryCodeEntry() { Alpha2 = "DK", Alpha3 = "DNK", CountryName = "Denmark", IsSEPAMember = true });
			...
			_alpha3Map.Add("EE", new CountryCodeEntry() { Alpha2 = "EE", Alpha3 = "EST", CountryName = "Estonia", IsSEPAMember = true });
			...
			_alpha3Map.Add("FI", new CountryCodeEntry() { Alpha2 = "FI", Alpha3 = "FIN", CountryName = "Finland", IsSEPAMember = true, IsUsingEuros = true });
			_alpha3Map.Add("FR", new CountryCodeEntry() { Alpha2 = "FR", Alpha3 = "FRA", CountryName = "France", IsSEPAMember = true, IsUsingEuros = true });
			_alpha3Map.Add("GF", new CountryCodeEntry() { Alpha2 = "GF", Alpha3 = "GUF", CountryName = "French Guiana", IsSEPAMember = true, IsUsingEuros = true });
			...
			_alpha3Map.Add("GI", new CountryCodeEntry() { Alpha2 = "GI", Alpha3 = "GIB", CountryName = "Gibraltar", IsSEPAMember = true });
			...
			_alpha3Map.Add("GP", new CountryCodeEntry() { Alpha2 = "GP", Alpha3 = "GLP", CountryName = "Guadeloupe", IsSEPAMember = true, IsUsingEuros = true });
			...
			_alpha3Map.Add("HR", new CountryCodeEntry() { Alpha2 = "HR", Alpha3 = "HRV", CountryName = "Croatia", IsSEPAMember = true });
			...
			_alpha3Map.Add("IE", new CountryCodeEntry() { Alpha2 = "IE", Alpha3 = "IRL", CountryName = "Ireland", IsSEPAMember = true, IsUsingEuros = true });
			_alpha3Map.Add("IS", new CountryCodeEntry() { Alpha2 = "IS", Alpha3 = "ISL", CountryName = "Iceland", IsSEPAMember = true });
			_alpha3Map.Add("IT", new CountryCodeEntry() { Alpha2 = "IT", Alpha3 = "ITA", CountryName = "Italy", IsSEPAMember = true, IsUsingEuros = true });
			...
			_alpha3Map.Add("CY", new CountryCodeEntry() { Alpha2 = "CY", Alpha3 = "CYP", CountryName = "Cyprus", IsSEPAMember = true, IsUsingEuros = true });
			...
			_alpha3Map.Add("LI", new CountryCodeEntry() { Alpha2 = "LI", Alpha3 = "LIE", CountryName = "Liechtenstein", IsSEPAMember = true });
			_alpha3Map.Add("LT", new CountryCodeEntry() { Alpha2 = "LT", Alpha3 = "LTU", CountryName = "Lithuania", IsSEPAMember = true });
			_alpha3Map.Add("LV", new CountryCodeEntry() { Alpha2 = "LV", Alpha3 = "LVA", CountryName = "Latvia", IsSEPAMember = true, IsUsingEuros = true });
			_alpha3Map.Add("LU", new CountryCodeEntry() { Alpha2 = "LU", Alpha3 = "LUX", CountryName = "Luxembourg", IsSEPAMember = true, IsUsingEuros = true });
			...
			_alpha3Map.Add("HU", new CountryCodeEntry() { Alpha2 = "HU", Alpha3 = "HUN", CountryName = "Hungary", IsSEPAMember = true });
			...
			_alpha3Map.Add("MT", new CountryCodeEntry() { Alpha2 = "MT", Alpha3 = "MLT", CountryName = "Malta", IsSEPAMember = true,IsUsingEuros = true });
			...
			_alpha3Map.Add("MQ", new CountryCodeEntry() { Alpha2 = "MQ", Alpha3 = "MTQ", CountryName = "Martinique", IsSEPAMember = true, IsUsingEuros = true });
			...
			_alpha3Map.Add("YT", new CountryCodeEntry() { Alpha2 = "YT", Alpha3 = "MYT", CountryName = "Mayotte", IsSEPAMember = true, IsUsingEuros = true });
			...
			_alpha3Map.Add("MC", new CountryCodeEntry() { Alpha2 = "MC", Alpha3 = "MCO", CountryName = "Monaco", IsSEPAMember = true, IsUsingEuros = true });
			...
			_alpha3Map.Add("DE", new CountryCodeEntry() { Alpha2 = "DE", Alpha3 = "DEU", CountryName = "Germany", IsSEPAMember = true, IsUsingEuros = true });
			...
			_alpha3Map.Add("NL", new CountryCodeEntry() { Alpha2 = "NL", Alpha3 = "NLD", CountryName = "Netherlands (the)", IsSEPAMember = true, IsUsingEuros = true });
			_alpha3Map.Add("NF", new CountryCodeEntry() { Alpha2 = "NF", Alpha3 = "NFK", CountryName = "Norfolk Island" });
			_alpha3Map.Add("NO", new CountryCodeEntry() { Alpha2 = "NO", Alpha3 = "NOR", CountryName = "Norway", IsSEPAMember = true });
			...
			_alpha3Map.Add("PL", new CountryCodeEntry() { Alpha2 = "PL", Alpha3 = "POL", CountryName = "Poland", IsSEPAMember = true });
			_alpha3Map.Add("PR", new CountryCodeEntry() { Alpha2 = "PR", Alpha3 = "PRI", CountryName = "Puerto Rico" });
			_alpha3Map.Add("PT", new CountryCodeEntry() { Alpha2 = "PT", Alpha3 = "PRT", CountryName = "Portugal", IsSEPAMember = true, IsUsingEuros = true });            
			_alpha3Map.Add("RE", new CountryCodeEntry() { Alpha2 = "RE", Alpha3 = "REU", CountryName = "Réunion", IsSEPAMember = true, IsUsingEuros = true });
			_alpha3Map.Add("GQ", new CountryCodeEntry() { Alpha2 = "GQ", Alpha3 = "GNQ", CountryName = "Equatorial Guinea" });
			_alpha3Map.Add("RO", new CountryCodeEntry() { Alpha2 = "RO", Alpha3 = "ROU", CountryName = "Romania", IsSEPAMember = true });
			...
			_alpha3Map.Add("GR", new CountryCodeEntry() { Alpha2 = "GR", Alpha3 = "GRC", CountryName = "Greece", IsSEPAMember = true, IsUsingEuros = true });
			_alpha3Map.Add("PM", new CountryCodeEntry() { Alpha2 = "PM", Alpha3 = "SPM", CountryName = "Saint Pierre and Miquelon", IsSEPAMember = true, IsUsingEuros = true });
			...
			_alpha3Map.Add("SK", new CountryCodeEntry() { Alpha2 = "SK", Alpha3 = "SVK", CountryName = "Slovakia", IsSEPAMember = true, IsUsingEuros = true });
			_alpha3Map.Add("SI", new CountryCodeEntry() { Alpha2 = "SI", Alpha3 = "SVN", CountryName = "Slovenia", IsSEPAMember = true, IsUsingEuros = true });
			...
			_alpha3Map.Add("BL", new CountryCodeEntry() { Alpha2 = "BL", Alpha3 = "BLM", CountryName = "Saint Barthélemy", IsSEPAMember = true, IsUsingEuros = true });
			_alpha3Map.Add("KN", new CountryCodeEntry() { Alpha2 = "KN", Alpha3 = "KNA", CountryName = "Saint Kitts and Nevis" });
			_alpha3Map.Add("MF", new CountryCodeEntry() { Alpha2 = "MF", Alpha3 = "MAF", CountryName = "Saint Martin (French part)", IsSEPAMember = true, IsUsingEuros = true });
			...
			_alpha3Map.Add("ES", new CountryCodeEntry() { Alpha2 = "ES", Alpha3 = "ESP", CountryName = "Spain", IsSEPAMember = true, IsUsingEuros = true });
			...
			_alpha3Map.Add("SE", new CountryCodeEntry() { Alpha2 = "SE", Alpha3 = "SWE", CountryName = "Sweden", IsSEPAMember = true });
			_alpha3Map.Add("CH", new CountryCodeEntry() { Alpha2 = "CH", Alpha3 = "CHE", CountryName = "Switzerland", IsSEPAMember = true });
			...
			_alpha3Map.Add("GB", new CountryCodeEntry() { Alpha2 = "GB", Alpha3 = "GBR", CountryName = "United Kingdom (the)", IsSEPAMember = true });
	...
	public class CountryCodeEntry
	{
		...
		/// <summary>
		/// Flag to set if country is member of SEPA zone
		/// </summary>
		public bool IsSEPAMember { get; set; } = false;

		/// <summary>
		/// Flag to set if country uses EUR currency as main
		/// </summary>
		public bool IsUsingEuros { get; set; } = false;
		...
		public CountryCodeEntry Clone() => new CountryCodeEntry()
		{
			Alpha2 = this.Alpha2,
			Alpha3 = this.Alpha3,
			CountryName = this.CountryName,
			IsSEPAMember = this.IsSEPAMember,
			IsUsingEuros = this.IsUsingEuros
		};
	}
}
